...
If Odoo cannot detect `mumtaz_base`, `mumtaz_core`, `mumtaz_ai`, `mumtaz_cfo_base`, `mumtaz_cfo_ingestion`, `mumtaz_cfo_transactions`, `mumtaz_cfo_toolkit`, or `mumtaz_super_toolkit`, the issue is usually `addons_path`/permissions/cache, not module code.
...
mods = env['ir.module.module'].search([('name', 'in', ['mumtaz_base','mumtaz_core','mumtaz_ai','mumtaz_cfo_base','mumtaz_cfo_ingestion','mumtaz_cfo_transactions','mumtaz_cfo_toolkit','mumtaz_super_toolkit'])])
