...
If Odoo cannot detect `mumtaz_base`, `mumtaz_core`, `mumtaz_ai`, `mumtaz_cfo_base`, or `mumtaz_cfo_ingestion`, the issue is usually `addons_path`/permissions/cache, not module code.
